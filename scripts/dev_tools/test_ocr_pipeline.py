...
# Add project root to path (parent.parent because this file is in tests/)
PROJECT_ROOT = Path(__file__).parent.parent.absolute()
sys.path.insert(0, str(PROJECT_ROOT))

# Test image path (in dump/ folder)
TEST_IMAGE = PROJECT_ROOT / "data" / "ocr_test.jpeg"
...
def test_process_vendor_image():
    ...
    test_vendor = TEST_PHONE_NUMBER  # Test vendor phone from env
